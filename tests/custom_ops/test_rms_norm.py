...
def test_spyre_rmsnorm_matches_reference(num_tokens, hidden_size, use_residual):
    ...
    residual = torch.randn(num_tokens, hidden_size, dtype=dtype) if use_residual else None
