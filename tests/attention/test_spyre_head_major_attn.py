...
def test_head_major_dispatches_by_query_width(
    ...
    # Patched before the impl is built: __init__ reads _page_attn_compiled into _attn_fn.
    monkeypatch.setattr(hm, "_page_attn_compiled", spy("decode", hm._page_attn_compiled))
    monkeypatch.setattr(
