...
def configure_pooling_for_spyre(
    ...
    gather. Passed in rather than re-derived here: only the caller is guaranteed to
    run inside a ``set_current_vllm_config`` context, and token pooling degrades to
    plain stick alignment without it.
    """
